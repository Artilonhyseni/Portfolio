    ...
    <section className="about-me">
      <div className="container">
        ...
        <p className="description">
          My name is Artilon Hyseni, i’m a 23-year old front-end developer, and
          digital designer living in Aarhus, Denmark. I thrive on creating
        ...
        <button className="recent-work-btn">Recent work</button>
      </div>
    </section>
  );
};
